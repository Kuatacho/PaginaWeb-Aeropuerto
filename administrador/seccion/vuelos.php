    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <input type="text" required value="<?php echo $txtObservacion; ?>" class="form-control" name="txtObservacion" id="txtObservacion" placeholder="Observacion">
                </div>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $vuelos['observacion']; ?> </td>
