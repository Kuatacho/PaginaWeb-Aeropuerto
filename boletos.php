...
<div class="container">
    <div class="row justify-content-center">
        <center><h1>Reserva Tus Boletos</h1></center>
    </div>
</div>
    ...
    if($_POST){
        ...
        if(count($rows)){
              foreach($rows as $row){ ?>
                ...
                <img class="card-img-top" src="img/reserva.png" width="" alt="">
                <div class="card-body">
                ...
                <p class="card-text">Puerta: <?php echo $row->puerta; ?> </p>
                    ...
                    <a name="" id="" class="btn btn-primary" href="reservatuboleto.php" role="button"> RESERVA YA!</a>
                </div>
                <?php
            }
