...
<div class="container">
            <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title">SERVICIO DE ENCOMIENDAS NACIONALES </h4>
                    ...
                    <div class="col-md-4 mb-3">
                    <label for="validationCustom01">Ingrese el Departamento de origen:</label>
                    <input type="text" class="form-control" name ="txtorigen" id="txtorigen" placeholder="Departamento de origen" value="" required>
                    <div class="valid-feedback">
                    </div>
                    </div>
                    <div class="col-md-4 mb-3">
                    <label for="validationCustom01">Ingrese el Departamento de llegada :</label>
                    <input type="text" class="form-control" name ="txtllegada" id="txtllegada" placeholder="Departamento de llegada" value="" required>
                    <div class="valid-feedback">
                    </div>
                    </div>
                    <div class="col-md-4 mb-3">
