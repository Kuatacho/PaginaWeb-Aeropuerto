...
$sentenciaSQL=$conexion->prepare("INSERT INTO encomiendasinternacionales (nombre, carnet, nombredestinatario, carnetdestinatario, vuelo, aerolinea, origen, llegada, fecha) VALUES (:nombre, :carnet, :nombredestinatario, :carnetdestinatario, :vuelo, :aerolinea, :origen, :llegada, :fecha);");
